    ...
    <div class="container py-4">
      <div class="row align-items-center g-4">
        ...
        <div class="col-lg-6 text-center">
          <img src="https://picsum.photos/600/400?healthy-food" class="img-fluid rounded shadow-lg" alt="Healthy Food">
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row g-4 align-items-center">
        <div class="col-lg-6">
          ...
          <p class="text-secondary">
            ...
            Kami menyediakan rekomendasi resep sehat, panduan nutrisi, serta reminder untuk pola hidup seimbang.
          </p>
        ...
        <div class="col-lg-6">
          <img src="https://picsum.photos/500/350?hospital" class="img-fluid rounded shadow-lg" alt="About HeartFit">
        </div>
      </div>
    </div>
  </section>
