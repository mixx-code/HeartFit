<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @if(session('user') && session('user.role') === 'admin')
            ...
            <li
                class="menu-item {{ request()->is('petugas*') || request()->is('admin*') || request()->is('customers*') ? 'active open' : '' }}">
            ...
            <li class="menu-item {{ request()->is('add*') ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-detail"></i>
                    <div data-i18n="Form Elements">Add Products</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item {{ request()->is('addPaketMakanan') ? 'active' : '' }}">
                        <a href="{{ url('/addPaketMakanan') }}" class="menu-link">
