  ...
  <div class="card">
    ...
    <div class="card-header d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
      ...
      <div class="d-flex flex-column flex-md-row align-items-md-center gap-2">
        ...
        <form class="d-flex align-items-center gap-2" method="GET" action="{{ route('admin.products.packageType') }}">
        ...
        {{-- Tombol Tambah Data --}}
        <a class="btn btn-success" href="{{ route('admin.products.packageType.addPackageType') }}">
